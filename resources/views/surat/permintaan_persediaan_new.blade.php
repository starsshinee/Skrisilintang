...
<head>
    ...
    <title>Surat Permintaan Persediaan - {{ $request->user->nama_lengkap }}</title>
    <style>
        body {
...
{{-- KOP SURAT --}}
    ...
    <div class="content">
        <p style="text-align: center; margin: 20px 0;">
            <strong>SURAT PERMINTAAN PERSEDIAAN</strong>
        </p>

        <p>Yang bertanda tangan di bawah ini:</p>

        <div class="data">
            <p>Nama&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $request->user->nama_lengkap }}</p>
            <p>NIP&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $request->user->nip }}</p>
            <p>Jabatan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $request->user->jabatan ?? 'Staff Balai Penjaminan Mutu Pendidikan Provinsi Gorontalo' }}</p>
        </div>

        <p>Dengan ini mengajukan permintaan persediaan dengan rincian sebagai berikut:</p>

        <div class="data">
            <p>Nama Barang&nbsp;&nbsp;&nbsp;: {{ $request->nama_barang }}</p>
            <p>Jumlah&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $request->jumlah }} unit</p>
            <p>Peruntukan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: {{ $request->deskripsi_peruntukan ?? 'Keperluan Dinas' }}</p>
        </div>

        <p>Persediaan tersebut diperlukan untuk keperluan operasional dan akan digunakan sesuai dengan peruntukannya.</p>

        <p>Demikian permintaan ini kami sampaikan, atas perhatian dan persetujuan Bapak/Ibu, kami ucapkan terima kasih.</p>
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>Dokumen ini digenerate secara otomatis oleh Sistem Inventaris Balai Penjaminan Mutu Pendidikan Provinsi Gorontalo</p>
        <p>Dicetak pada: {{ $tanggalCetak ?? now()->translatedFormat('d F Y, H:i') }} WIB</p>
    </div>
</body>
</html>
