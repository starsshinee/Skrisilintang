...
<head>
    <meta charset="UTF-8">
    <title>Surat Pengembalian Kendaraan</title>
    <style>
        /* 1. PENGATURAN KERTAS A4 & MARGIN (1 HALAMAN) */
        @page {
            size: A4 portrait;
            margin-top: 2cm;
            margin-bottom: 1.5cm;
...
<body>
    ...
    <div class="judul-container">
        <div class="judul-surat">PENGEMBALIAN KENDARAAN DINAS</div>
    ...
    <table class="data-table">
        <tr>
            ...
            <td class="td-titikdua">:</td>
            <td>{{ $pengembalian->peminjamanKendaraan->nama_barang ?? 'Kendaraan Operasional' }}</td>
        </tr>
        <tr>
            <td class="td-label">No. Polisi / Merk</td>
            <td class="td-titikdua">:</td>
            <td>{{ $pengembalian->peminjamanKendaraan->merek ?? '-' }}</td>
        </tr>
        <tr>
