...
<main class="main">
    ...
    <div class="header">
        <div class="header-left">
            <div class="header-title">Pengembalian Kendaraan</div>
        </div>
    ...
    <div class="container">
        <div class="page-header">
            <div>
                <div class="page-title">Pengembalian Kendaraan</div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Toyota Avanza</td>
                        <td>2025-01-16</td>
                        <td><span class="badge badge-baik">Baik</span></td>
                    ...
                    <tr>
                        ...
                        <td>Honda Civic</td>
                        <td>2025-01-15</td>
                        <td><span class="badge badge-rusak">Rusak Ringan</span></td>
                        <td><span class="badge badge-perlu-review">Perlu Review</span></td>
                        <td>
                            <div class="action-buttons">
                                <button class="icon-btn">👁️</button>
                                <button class="icon-btn">🗑️</button>
