...
<title>Permintaan Persediaan - Dashboard Kasubag</title>
...
<main class="main">
  <div class="page-header">
    ...
    <div class="page-header-text"><h1>Permintaan Persediaan</h1><p>2 permintaan menunggu verifikasi</p></div>
  </div>
  ...
  <div class="req-card">
    <div class="req-info">
      <div class="req-tags"><span class="tag id">REQ004</span><span class="tag pending">Menunggu</span></div>
      <div class="req-name">Kertas A4 (10 rim), Tinta Printer (5 set)</div>
      <div class="req-meta">
        <span>Pemohon: <strong>Dewi Lestari</strong></span>
        <span>Tanggal Ajuan: <strong>2024-12-12</strong></span>
        <span>Mulai: <strong>2024-12-13</strong></span>
      </div>
      <div class="req-purpose">Tujuan: <span>Kebutuhan cetak laporan akhir tahun</span></div>
    </div>
  ...
  <div class="req-card highlighted">
    <div class="req-info">
      <div class="req-tags"><span class="tag id">REQ008</span><span class="tag pending">Menunggu</span></div>
      <div class="req-name">Amplop Coklat (200 pcs), Map Folio (100)</div>
      <div class="req-meta">
        <span>Pemohon: <strong>Lina Mariana</strong></span>
        <span>Tanggal Ajuan: <strong>2024-12-14</strong></span>
        <span>Mulai: <strong>2024-12-15</strong></span>
      </div>
      <div class="req-purpose">Tujuan: <span>Pengiriman surat undangan kegiatan tahunan</span></div>
    </div>
    <div class="req-actions">
      <button class="btn btn-detail"><svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg> Detail</button>
      <button class="btn btn-approve"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg> Setuju</button>
