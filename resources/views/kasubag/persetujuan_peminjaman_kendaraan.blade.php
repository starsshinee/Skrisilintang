...
<title>Peminjaman Gedung - Dashboard Kasubag</title>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .page-header-icon { width: 48px; height: 48px; background: var(--orange-light); border-radius: 14px; display: flex; align-items: center; justify-content: center; }
  .page-header-icon svg { width: 24px; height: 24px; stroke: var(--orange); fill: none; stroke-width: 2; }
...
<main class="main">
  <div class="page-header">
    <div class="page-header-icon"><svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg></div>
    <div class="page-header-text"><h1>Peminjaman Gedung</h1><p>2 permintaan menunggu verifikasi</p></div>
  </div>
  ...
  <div class="req-card">
    <div class="req-info">
      <div class="req-tags"><span class="tag id">REQ003</span><span class="tag pending">Menunggu</span></div>
      <div class="req-name">Aula Lt.3 (Kapasitas 200)</div>
      <div class="req-meta">
        <span>Pemohon: <strong>Ahmad Fauzi</strong></span>
        <span>Tanggal Ajuan: <strong>2024-12-11</strong></span>
        <span>Mulai: <strong>2024-12-20</strong></span>
        <span>Selesai: <strong>2024-12-20</strong></span>
      </div>
      <div class="req-purpose">Tujuan: <span>Seminar internal peningkatan SDM</span></div>
    </div>
  ...
  <div class="req-card highlighted">
    <div class="req-info">
      <div class="req-tags"><span class="tag id">REQ007</span><span class="tag pending">Menunggu</span></div>
      <div class="req-name">Ruang Meeting Lt.2 (Kapasitas 30)</div>
      <div class="req-meta">
        <span>Pemohon: <strong>Hendra Pratama</strong></span>
        <span>Tanggal Ajuan: <strong>2024-12-13</strong></span>
        <span>Mulai: <strong>2024-12-17</strong></span>
        <span>Selesai: <strong>2024-12-17</strong></span>
      </div>
      <div class="req-purpose">Tujuan: <span>Workshop perencanaan anggaran 2025</span></div>
    </div>
    <div class="req-actions">
      <button class="btn btn-detail"><svg viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg> Detail</button>
      <button class="btn btn-approve"><svg viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12"/></svg> Setuju</button>
