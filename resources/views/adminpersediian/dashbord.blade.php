...
<head>
  ...
  <title>Dashboard Admin Persediaan – SIBMN</title>
  ...
  <main class="flex-1 overflow-auto p-8">
    <div class="flex items-center justify-between mb-8 anim">
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="w-10 h-10 rounded-full bg-emerald-600 flex items-center justify-center text-white font-bold text-sm">{{ strtoupper(substr(auth()->user()->name,0,1)) }}</div>
      </div>
    </div>
    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
      @foreach([['label'=>'Total Persediaan','value'=>'391','color'=>'bg-emerald-100 text-emerald-600'],['label'=>'Stok Kritis','value'=>'8','color'=>'bg-red-100 text-red-600'],['label'=>'Mutasi Bulan Ini','value'=>'34','color'=>'bg-blue-100 text-blue-600']] as $s)
