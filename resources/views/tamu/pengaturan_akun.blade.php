        ...
        <div class="section-card animate d2">
          <div class="section-header">
            <div>
              ...
              <div class="section-sub">Tanda tangan akan digunakan pada surat peminjaman aset</div>
            </div>
          </div>
          <div class="section-body">
            <!-- Current Signature -->
    ...
    <div>
      ...
      <div class="info-card animate d3">
        ...
        <div class="quick-list">
          <a href="{{ route('tamu.peminjaman-aset') }}" class="quick-item"><i class="fas fa-plus-circle"></i> Ajukan Peminjaman</a>
