                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <div class="form-label"><i class="fas fa-building-columns"></i> Instansi / Lembaga <span
                                class="req">*</span></div>
                        <input type="text" class="form-input" placeholder="Nama instansi atau lembaga"
                            id="instansiInput">
                    </div>
                    <div class="form-group">
                        <div class="form-label"><i class="fas fa-location-dot"></i> Kabupaten / Kota <span
                                class="req">*</span></div>
                            ...
                            @foreach ($gedungs as $kategori => $items)
                                <optgroup label="{{ ucwords(str_replace('_', ' ', $kategori)) }}">
                                    @foreach ($items as $gedung)
                                        <option value="{{ $gedung->id }}" data-kategori="{{ $gedung->kategori }}"
                                            data-tarif="{{ $gedung->tarif_sewa }}"
                                            data-kapasitas="{{ $gedung->kapasitas }}"
                                            data-lokasi="{{ $gedung->lokasi }}" data-icon="{{ $gedung->icon }}">
                                            {{ $gedung->nama_gedung }} - {{ $gedung->lokasi }}
                                            ({{ $gedung->kapasitas }} Orang)
                                        </option>
                                    @endforeach
                                </optgroup>
                            @endforeach
                        ...
                        <div class="facility-preview" id="facilityPreview">
                            ...
                            <div style="flex:1;min-width:0">
                                ...
                                <div class="fp-details" style="gap:8px;align-items:center">
                                    ...
                                    <span class="fp-tag" id="fpLokasi"
                                        style="background:rgba(6,182,212,0.1);color:var(--accent)"></span>
                                    <span class="fp-tag bg-success" id="fpStatus"
                                        style="background:rgba(16,185,129,0.2) !important;color:var(--success) !important">
                    ...
                    <div class="input-row">
                        <div class="form-group">
                            <div class="form-label"><i class="fas fa-clock"></i> Jam Mulai <span
                                    class="req">*</span></div>
                            <input type="time" class="form-input" id="jamMulaiInput">
                        </div>
                        <div class="form-group">
                            <div class="form-label"><i class="fas fa-clock"></i> Jam Selesai <span
                                    class="req">*</span></div>
                    ...
                    <div class="form-group">
                        <div class="form-label"><i class="fas fa-users"></i> Jumlah Peserta <span
                                class="req">*</span></div>
                        <input type="number" min="1" class="form-input" id="jumlahPesertaInput"
                            ...
                            <div class="req-card" data-status="{{ $status[0] }}" data-id="{{ $item['id'] }}">
                                ...
                                <div class="req-card-footer">
                                    ...
                                    @if (!empty($item['surat_path']))
                                        <a href="{{ asset('storage/' . $item['surat_path']) }}" target="_blank"
                                            class="card-btn"
                                            style="background: rgba(59,130,246,0.1); color: var(--primary); text-decoration: none;">
                                    ...
                                    @if (in_array($item['status'], ['disetujui', 'disetujui_kasubag']) && !empty($item['surat_perjanjian_path']))
                                        <a href="{{ asset('storage/' . $item['surat_perjanjian_path']) }}"
                                            target="_blank" class="card-btn"
                                            style="background: rgba(16,185,129,0.1); color: var(--success); text-decoration: none;">
                        ...
                        @empty
                            <div style="padding:40px 0;text-align:center;color:var(--text-secondary)">
                                <i class="fas fa-clock-rotate-left"
                                    style="font-size:48px;opacity:0.3;margin-bottom:12px;display:block"></i>
...
">
  ...
  ">
    ...
    ">
                <div
                    style="position:absolute;right:-20px;top:-20px;width:100px;height:100px;border-radius:50%;background:rgba(255,255,255,0.08)">
                </div>
            ...
            <div style="padding:24px 28px" id="detailBody">
                <div id="detailLoading" style="text-align:center;padding:40px 0;color:var(--text-secondary)">
                    <i class="fas fa-spinner fa-spin"
                        style="font-size:32px;opacity:0.4;display:block;margin-bottom:12px"></i>
                    <div style="font-size:14px">Memuat detail...</div>
                </div>

                <div id="detailContent" style="display:none">
                    <div style="text-align:center;margin-bottom:20px">
                        <span id="detailStatusBadge" class="status-badge"
                            style="font-size:13px;padding:6px 16px"></span>
                    </div>

                    <div style="margin-bottom:20px">
                        <div
                            style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:var(--text-secondary);margin-bottom:10px;display:flex;align-items:center;gap:6px">
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                                <div
                                    style="font-size:10px;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:.5px">
                                    Nama</div>
                    ...
                    <div style="margin-bottom:20px">
                        ...
                        <div
                            style="background:linear-gradient(135deg,#eff4ff,#f0fdff);padding:14px;border-radius:12px;border:1px solid #c7d7ff">
                            <div id="detailFasilitas"
                                style="font-size:15px;font-weight:700;color:var(--text-primary)"></div>
                            <div style="display:flex;gap:8px;margin-top:6px;flex-wrap:wrap">
                                <span id="detailKategori"
                                    style="font-size:10px;background:rgba(37,99,235,0.1);color:var(--primary);padding:2px 8px;border-radius:5px;font-weight:600"></span>
                                <span id="detailLokasi"
                                    style="font-size:10px;background:rgba(6,182,212,0.1);color:var(--accent);padding:2px 8px;border-radius:5px;font-weight:600"></span>
                            </div>

                            <div
                                style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:12px;border-top:1px dashed #c7d7ff;padding-top:12px;">
                                <div>
                                    <div
                    ...
                    <div style="margin-bottom:20px">
                        <div
                            style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:var(--text-secondary);margin-bottom:10px;display:flex;align-items:center;gap:6px">
                            <i class="fas fa-calendar" style="color:var(--warning);font-size:10px"></i> Waktu
                            Peminjaman
                        </div>
                        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px">
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                            ...
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                                <div
                                    style="font-size:10px;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:.5px">
                                    Tgl Kembali</div>
                                <div id="detailTglKembali" style="font-size:13px;font-weight:600;margin-top:3px">
                                </div>
                            </div>
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                                <div
                        ...
                        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px">
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                                <div
                                    ...
                                    Tarif/Hari</div>
                                <div id="detailTarif"
                                    style="font-size:13px;font-weight:600;margin-top:3px;color:var(--primary)"></div>
                            </div>
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                                <div
                                    style="font-size:10px;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:.5px">
                                    Total</div>
                                <div id="detailTotal"
                                    style="font-size:13px;font-weight:700;margin-top:3px;color:var(--success)"></div>
                            </div>
                            <div style="background:#f8faff;padding:10px 14px;border-radius:10px">
                                <div
                                    style="font-size:10px;color:#94a3b8;font-weight:600;text-transform:uppercase;letter-spacing:.5px">
                    ...
                    <div style="margin-bottom:20px">
                        <div
                            style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:var(--text-secondary);margin-bottom:10px;display:flex;align-items:center;gap:6px">
                            <i class="fas fa-bullseye" style="color:var(--danger);font-size:10px"></i> Tujuan
                            Penggunaan
                        </div>
                        <div id="detailTujuan"
                            style="background:#f8faff;padding:12px 14px;border-radius:10px;font-size:13px;line-height:1.6;color:var(--text-primary)">
                        </div>
                    </div>
                    ...
                    <div id="detailKomentarWrap" style="margin-bottom:20px;display:none">
                        ...
                        <div id="detailKomentar"
                            style="background:#fef3c7;padding:12px 14px;border-radius:10px;font-size:13px;line-height:1.6;color:#92400e;border:1px solid #fcd34d">
                        </div>
                    </div>

                    <div id="detailSuratWrap"
                        style="margin-bottom:16px; display:flex; flex-direction:column; gap:8px;">
                        <div id="wrapSuratPermohonan" style="display:none">
                            <div
                                style="font-size:10px; font-weight:700; text-transform:uppercase; color:var(--text-secondary); margin-bottom:4px;">
                                Dokumen Permohonan (Anda)</div>
                            <a id="btnSuratPermohonan" href="#" target="_blank"
                                style="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:10px;background:rgba(59,130,246,0.05);border:1px solid rgba(59,130,246,0.15);color:var(--primary);font-size:13px;font-weight:600;text-decoration:none;">
                        ...
                        <div id="wrapSuratPerjanjian" style="display:none; margin-top:8px;">
                            <div
                                style="font-size:10px; font-weight:700; text-transform:uppercase; color:var(--text-secondary); margin-bottom:4px;">
                                Dokumen Perjanjian Final (Admin)</div>
                            <a id="btnSuratPerjanjian" href="#" target="_blank"
                                style="display:flex;align-items:center;gap:8px;padding:10px 14px;border-radius:10px;background:rgba(16,185,129,0.05);border:1px solid rgba(16,185,129,0.15);color:var(--success);font-size:13px;font-weight:600;text-decoration:none;">
        ...
        $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        if (res.success && res.data) {
                            ...
                            const statusClass = {
                                'pending': 'pending',
                                'dalam_review': 'pending',
                                'disetujui_kasubag': 'approved',
                                'disetujui': 'approved',
                                'ditolak': 'rejected'
                            };
                            const statusIcon = {
                                'pending': 'fa-clock',
                                'dalam_review': 'fa-hourglass-half',
                                'disetujui_kasubag': 'fa-check',
                            ...
                            $('#detailStatusBadge')
                                ...
                                .html(
                                    `<i class="fas ${statusIcon[d.status] || 'fa-circle'}"></i> ${d.status_label}`
                                );
                            ...
                            $('#detailKategori').text(d.fasilitas ? d.fasilitas.replace(/_/g, ' ')
            ...
            function showFacilityPreview(gedungId) {
                ...
                if (gedungId && window.fasilitasData[gedungId]) {
                    ...
                    $('#fpStatus').html('<i class="fas fa-check-circle" style="font-size:9px"></i> ' + gedung
                        .ketersediaan);
            ...
            function showToast(msg, type = 'success') {
                ...
                icon.removeClass().addClass(type === 'error' ? 'fas fa-exclamation-triangle' :
                    'fas fa-check-circle');
            ...
            window.scrollToForm = () => $('#formCard')[0].scrollIntoView({
                behavior: 'smooth'
            });
            window.scrollToHistory = () => $('.history-card')[0].scrollIntoView({
                behavior: 'smooth'
            });
