      ...
      <div class="form-body">
        ...
        <div class="form-group">
          ...
          <select class="form-select" id="fasilitasSelect" onchange="onFasilitasChange()">
            ...
            <option value="aula">Ruang Pertemuan (Ruang Ponuwa) (200 Orang)</option>
            <option value="vip">Ruang Pertemuan (Ruang Ponuwa) (20 Orang)</option>
            <option value="lab">Ruang Belajar (Tinelo 1,2,3,4,5) (30 Unit PC)</option>
            <option value="pelatihan">Ruang Belajar (Tinelo 1,2,3) (40 Orang)</option>
            <option value="minibus">Ruang Makan (Olamita 1) (60 Orang)</option>
            <option value="asrama">Ruang Makan (Olamita 2) (60 Orang)</option>
            <option value="gedung">Asrama Beledaa 1,2,3 (120 Orang)</option>
            <option value="mess">Asrama Beledaa 4 (5 Orang)</option>
            <option value="volly">Mess bandayo daa (10 Orang)</option>
             <option value="volly">Mess bandayo kiki 1,2,3,4 (10 Orang)</option>
          </select>
        ...
        <div class="form  group">
          <div class="form-label"><i class="fas fa-cloc"></i> *Jam Mulai <span class="req">*</span></div>
        ...
        <div class="form-group">
          <div class="form-label"><i class= "fas fa-envelope"></i> Upload Surat (optional) <span class="req">*</span></div>
                <input type="file" name="surat" accept=".pdf,.doc,.docx,.jpg,.jpeg,.png" class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                <div class="form-label"><i class="fas fa-info-circle"></i> Format: PDF, DOC (Maks 5MB) (Opsional)</div>
        </div>
